<?php
/**
 * German catalogue: source string => translation.
 *
 * Written by tools, reviewed by hand. Generated files are built from this.
 *
...
return array(
	...
	'Additional guest (%d)' => array( 'Zusätzlicher Gast (%d)', 'Zusätzliche Gäste (%d)' ),
	'%s each' => 'je %s',
	...
	'Another apartment that is free' => array( 'Eine andere Wohnung ist frei', 'Andere Wohnungen sind frei' ),
	...
	'Overnight rate (Sun–Thu)' => 'Übernachtungspreis (So–Do)',
	'Overnight rate (Fri/Sat)' => 'Übernachtungspreis (Fr/Sa)',
	'Charged per night. Leave at 0 to use the weekday rate.' => 'Wird pro Nacht berechnet. Bei 0 gilt der Wochentagspreis.',
	'Charged per night. Leave at 0 to use the weekend rate.' => 'Wird pro Nacht berechnet. Bei 0 gilt der Wochenendpreis.',
	'The top row prices an hourly booking; the overnight row prices a night, and is what an overnight stay is charged.' => 'Die obere Zeile bestimmt den Preis einer stundenweisen Buchung; die Übernachtungszeile bestimmt den Preis einer Nacht und wird für Übernachtungen berechnet.',
...
<p><a href="{{admin_url}}">Buchung im Adminbereich öffnen</a></p>',
	...
	'%d calendar link was not saved — it is not a usable address, or the same calendar was listed twice.' => array( '%d Kalender-Link wurde nicht gespeichert — er ist keine brauchbare Adresse, oder derselbe Kalender wurde zweimal aufgeführt.', '%d Kalender-Links wurden nicht gespeichert — sie sind keine brauchbaren Adressen, oder derselbe Kalender wurde zweimal aufgeführt.' ),
	...
	'%1$s – %2$s' => '%1$s – %2$s',
	'On this day the daytime booking runs from %1$s to %2$s. For other times, please book an overnight stay.' => 'An diesem Tag läuft die Tagesbuchung von %1$s bis %2$s. Für andere Zeiten buchen Sie bitte eine Übernachtung.',
	'That day is no longer open for daytime bookings.' => 'Dieser Tag ist für Tagesbuchungen nicht mehr geöffnet.',
	'The daytime booking on this day is already taken. An overnight stay may still be free.' => 'Die Tagesbuchung an diesem Tag ist bereits vergeben. Eine Übernachtung ist möglicherweise noch frei.',
	'Available for' => 'Verfügbar für',
	'Every apartment offers this extra. Tick one or more to limit it.' => 'Jedes Apartment bietet diesen Zusatz an. Wählen Sie ein oder mehrere aus, um ihn einzuschränken.',
	'Only the apartments ticked above offer this extra.' => 'Nur die oben ausgewählten Apartments bieten diesen Zusatz an.',
	'When to pay' => 'Wann bezahlen',
	'Pay now' => 'Jetzt bezahlen',
	'Pay later' => 'Später bezahlen',
	'Transfer the amount and attach the receipt. Your dates are confirmed once it arrives.' => 'Überweisen Sie den Betrag und fügen Sie den Beleg bei. Ihre Termine sind bestätigt, sobald die Zahlung eingeht.',
	'Book now and pay by bank transfer afterwards. We will send you the details.' => 'Jetzt buchen und anschließend per Überweisung bezahlen. Wir senden Ihnen die Bankdaten zu.',
	'No payment is needed now. We will send you the bank details, and your dates are held in the meantime.' => 'Jetzt ist keine Zahlung nötig. Wir senden Ihnen die Bankdaten; Ihre Termine bleiben so lange reserviert.',
	'Which extras guests can add to a booking of this apartment.' => 'Welche Zusatzleistungen Gäste zu einer Buchung dieses Apartments hinzufügen können.',
	'currently offered by every apartment' => 'derzeit von jedem Apartment angeboten',
	'Shortest booking (hours)' => 'Kürzeste Buchung (Stunden)',
	'Longest booking (hours)' => 'Längste Buchung (Stunden)',
	'Minutes between start times' => 'Minuten zwischen Startzeiten',
	'Earliest start time' => 'Früheste Startzeit',
	'Latest start time' => 'Späteste Startzeit',
	'Daytime slot days' => 'Tage mit Tagesbuchung',
	'Daytime slot from' => 'Tagesbuchung von',
	'Daytime slot until' => 'Tagesbuchung bis',
	'Hours the base rate covers' => 'Stunden, die der Grundpreis abdeckt',
	'Guests the base rate covers' => 'Gäste, die der Grundpreis abdeckt',
	'Allow paying later' => 'Später bezahlen erlauben',
	'Guests only. The booking form opens on this length, and anything shorter is refused. You are not held to it when booking from the admin.' => 'Nur für Gäste. Das Buchungsformular öffnet mit dieser Dauer, kürzere Buchungen werden abgelehnt. Im Adminbereich gilt diese Grenze für Sie nicht.',
	'The last time a booking may begin. A booking may still finish after it.' => 'Die späteste Zeit, zu der eine Buchung beginnen darf. Sie darf danach noch enden.',
	'Also the hours a night imported from Airbnb or Booking.com occupies, so a portal stay blocks the same window a direct one does.' => 'Zugleich die Zeiten, die eine von Airbnb oder Booking.com importierte Nacht belegt – ein Portal-Aufenthalt sperrt so dasselbe Zeitfenster wie eine Direktbuchung.',
	'1 is Monday, 7 is Sunday. Separate with commas, or leave empty for no daytime slot.' => '1 ist Montag, 7 ist Sonntag. Mit Kommas trennen oder leer lassen für keine Tagesbuchung.',
	'On the days listed above, that one fixed block is the whole daytime offer — free start times are not shown, and an overnight stay is the other option. On every other day guests pick their own start time.' => 'An den oben genannten Tagen ist dieser eine feste Block das gesamte Tagesangebot – freie Startzeiten werden nicht angezeigt, die Alternative ist eine Übernachtung. An allen anderen Tagen wählen Gäste ihre Startzeit selbst.',
...
<p>{{site_name}}</p>',
	...
	'Partially paid — outstanding: %s' => 'Teilweise bezahlt — offen: %s',
	'Paid in full — %s received' => 'Vollständig bezahlt — %s erhalten',
	'Overpayment — difference: %s' => 'Überzahlung — Differenz: %s',
	'Overnight stay' => 'Übernachtung',
	'Hourly booking' => 'Stundenweise Buchung',
	'Change to hourly' => 'Auf stundenweise umstellen',
	'Change to overnight' => 'Auf Übernachtung umstellen',
	'This changes the tax treatment' => 'Das ändert die steuerliche Behandlung',
	'This booking is filed as “%1$s”. Filing it as “%2$s” instead changes the VAT rate its invoice is drawn at. Any invoice already issued keeps the rate it was issued with.' => 'Diese Buchung ist als „%1$s“ erfasst. Eine Erfassung als „%2$s“ ändert den MwSt.-Satz, mit dem die Rechnung erstellt wird. Bereits ausgestellte Rechnungen behalten ihren Satz.',
	'Change the type' => 'Art ändern',
	'Leave it as it is' => 'Unverändert lassen',
	'Create invoice' => 'Rechnung erstellen',
	'Create the invoice' => 'Rechnung jetzt erstellen',
	'Creating…' => 'Wird erstellt …',
	'Open the invoice' => 'Rechnung öffnen',
	'Pick the VAT treatment. It is written onto the invoice and kept, so the same document prints the same way later even if the rates change.' => 'Wählen Sie die steuerliche Behandlung. Sie wird auf der Rechnung festgehalten, damit dasselbe Dokument später unverändert gedruckt wird, auch wenn sich die Sätze ändern.',
	'The invoice has been issued. Its number and rate are fixed from here on.' => 'Die Rechnung wurde ausgestellt. Nummer und Steuersatz stehen ab jetzt fest.',
	'Invoice %1$s, drawn at %2$s%% VAT.' => 'Rechnung %1$s, erstellt mit %2$s %% MwSt.',
	'The invoice could not be prepared for this booking.' => 'Die Rechnung konnte für diese Buchung nicht vorbereitet werden.',
	'Accommodation' => 'Beherbergung',
	'Everything else' => 'Alles Übrige',
	'%s%%' => '%s %%',
	'Download your booking confirmation (PDF)' => 'Buchungsbestätigung als PDF herunterladen',
	'Buchungsbestaetigung' => 'Buchungsbestaetigung',
	'BUCHUNGSBESTÄTIGUNG' => 'BUCHUNGSBESTÄTIGUNG',
	'Buchung für:' => 'Buchung für:',
	'Zahlung bis:' => 'Zahlung bis:',
	'Zahlung per Überweisung' => 'Zahlung per Überweisung',
	'Kontoinhaber:' => 'Kontoinhaber:',
	'IBAN:' => 'IBAN:',
	'BIC:' => 'BIC:',
	'Bank:' => 'Bank:',
	'Verwendungszweck:' => 'Verwendungszweck:',
	'Dies ist keine Rechnung. Ihre Rechnung erhalten Sie, sobald Ihre Zahlung bei uns eingegangen ist.' => 'Dies ist keine Rechnung. Ihre Rechnung erhalten Sie, sobald Ihre Zahlung bei uns eingegangen ist.',
	'Record a payment' => 'Zahlung erfassen',
	'Record the payment' => 'Zahlung jetzt erfassen',
	'Recording…' => 'Wird erfasst …',
	'Money that has reached the account. Record part of what is owed and the booking reads as partially paid; record more than is owed and it reads as overpaid.' => 'Geld, das auf dem Konto eingegangen ist. Erfassen Sie einen Teilbetrag, gilt die Buchung als teilweise bezahlt; erfassen Sie mehr als offen ist, als überzahlt.',
	'Which booking?' => 'Welche Buchung?',
	'Reference, guest or email' => 'Buchungsnummer, Gast oder E-Mail',
	...
	'What the bank statement said' => 'Was auf dem Kontoauszug stand',
	'Paid in full' => 'Vollständig bezahlt',
	'Overpaid by %s' => 'Überzahlt um %s',
	'Still outstanding: %s' => 'Weiterhin offen: %s',
