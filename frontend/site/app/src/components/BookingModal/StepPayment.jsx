/**
 * Step 4 — payment date and proof of transfer.
 *
	...
	return (
		<div className="bks-step">
			<div className="bks-step__row">
				{ /*
				 * No `min`: a transfer is usually made before the booking
				 * is finished, so the date this asks for is often in the
				 * past.
				 */ }
				<DateField
					id="bks-modal-payment-date"
					label={ __( 'Payment Date', 'booking-suite' ) }
					value={ payment.date || '' }
					min="2000-01-01"
