...
final class ExtrasTable {
	...
	public static function definition(): string {
		...
		// `image_url` is a plain URL rather than an attachment id, so an extra
		// can point at an image that does not live in the media library.
		// `sort_order` decides the order guests see; ties fall back to name.
