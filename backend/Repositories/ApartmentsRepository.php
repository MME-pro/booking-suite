...
final class ApartmentsRepository {
	...
	private const WRITABLE = array(
		...
		'weekday_rate'        => '%f',
		'weekend_rate'        => '%f',
		'weekday_overnight_rate' => '%f',
		'weekend_overnight_rate' => '%f',
		'surcharge_hour'      => '%f',
		'surcharge_guest'     => '%f',
		'holiday_hesse'       => '%d',
		'active'              => '%d',
	...
	private static function cast( array $row ): array {
		...
		return array(
			...
			'weekday_overnight_rate' => (float) ( $row['weekday_overnight_rate'] ?? 0 ),
			'weekend_overnight_rate' => (float) ( $row['weekend_overnight_rate'] ?? 0 ),
